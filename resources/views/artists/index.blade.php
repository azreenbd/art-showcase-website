                ...
                <a href="{{ url('/'.$artist->url) }}">
                    <div class="card m-1" style="width: 12rem;">
                        <div class="card-img-top" style="overflow:hidden; height: 12rem">
                            <img src="/img/avatar/{{ $artist->avatar }}" alt="{{ $artist->name }}" style="object-fit: cover; width: 12rem; height:12rem;" ondragstart="return false;" onselectstart="return false;" oncontextmenu="return false;">
                        </div>
